...
import { ArrowRight, CheckCircle2, Cpu, FileDigit, MonitorDot, ShieldCheck, Zap } from "lucide-react";
    ...
    <main className="bg-brand-black min-h-screen">
      ...
      <section className="relative min-h-[75vh] flex items-center justify-center pt-32 pb-20 overflow-hidden border-b border-white/5 text-center">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1920&q=80')] bg-cover bg-center grayscale opacity-20"
          />
        </div>
        ...
        <div className="container-custom relative z-20 px-6 md:px-12">
          ...
          >
            <div className="flex flex-col items-center mb-8">
              <span className="text-brand-red font-bold text-[10px] tracking-[0.6em] uppercase mb-4">E - Invoicing</span>
            ...
            <h1 className="text-5xl md:text-8xl font-black text-white uppercase leading-[0.9] mb-8 tracking-tighter">
              E-Invoicing. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-white">Simplified.</span>
            </h1>

            <p className="text-xl md:text-2xl text-brand-accent/60 max-w-2xl mx-auto leading-relaxed font-medium mb-12">
              E-invoicing solutions aligned to <span className="text-white">international standards</span>.
            </p>

            <div className="flex flex-wrap items-center justify-center gap-10 opacity-30">
              <div className="flex flex-col items-center">
                <span className="text-xl font-black text-white tracking-tighter uppercase">24/7</span>
                <span className="text-[8px] font-bold uppercase tracking-[0.3em] text-brand-red">Active Monitoring</span>
              </div>
              <div className="w-[1px] h-6 bg-white/10" />
              <div className="flex flex-col items-center">
                <span className="text-xl font-black text-white tracking-tighter uppercase">100%</span>
                <span className="text-[8px] font-bold uppercase tracking-[0.3em] text-brand-red">Digital Compliance</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 border-t border-white/5 bg-brand-black/50 backdrop-blur-xl z-30 flex items-center">
          <div className="container-custom flex items-center justify-between px-6 md:px-12 opacity-30">
            <div className="flex gap-12">
              <div className="text-[8px] font-bold text-white uppercase tracking-[0.4em]">E-Invoicing // Zeta Unit</div>
              <div className="text-[8px] font-bold text-white uppercase tracking-[0.4em]">Digital Ledger: Active</div>
            </div>
            ...
            <div className="lg:col-span-7">
              <ScrollReveal>
                ...
                <h2 className="text-4xl md:text-6xl font-black text-white uppercase mb-10 tracking-tighter leading-[0.9]">
                  Modern <br />
                  <span className="text-brand-red">Digital Transition.</span>
                </h2>
                
                <p className="text-brand-accent/70 text-xl leading-relaxed font-medium mb-12 max-w-2xl border-l-2 border-brand-red/20 pl-8">
                  We help businesses transition to and operate under e-invoicing frameworks — managing the technology, compliance, and reporting requirements end-to-end.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="p-8 bg-white/[0.02] border border-white/5 relative group hover:bg-white/[0.04] transition-all">
                    ...
                    <Cpu className="text-brand-red mb-6" size={28} />
                    <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-3">Tech Management</h4>
                    <p className="text-xs text-brand-accent/50 leading-relaxed">Full ownership of e-invoicing technology integration and configuration across your digital stack.</p>
                  </div>
                  <div className="p-8 bg-white/[0.02] border border-white/5 relative group hover:bg-white/[0.04] transition-all">
                    <div className="absolute top-0 left-0 w-[2px] h-0 bg-brand-red group-hover:h-full transition-all duration-500" />
                    <FileDigit className="text-brand-red mb-6" size={28} />
                    <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-3">Digital Compliance</h4>
                    <p className="text-xs text-brand-accent/50 leading-relaxed">Ensuring every digital invoice meets the exact technical and regulatory specifications of your jurisdiction.</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
              ...
              <ScrollReveal delay={0.2}>
                <div className="relative aspect-[4/5] bg-brand-dark overflow-hidden grayscale hover:grayscale-0 transition-all duration-1000 group">
                  ...
                  <div className="absolute bottom-10 left-10 z-20">
                    <div className="text-brand-red font-black text-4xl tracking-tighter uppercase">06</div>
      ...
      <section className="section-padding bg-brand-dark/30">
        <div className="container-custom text-center">
          <ScrollReveal>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase mb-16">End-to-End. <br />Jurisdiction Focused.</h2>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ScrollReveal delay={0.1} className="h-full">
              <div className="bg-brand-black border border-white/5 p-12 hover:border-brand-red/30 transition-all group h-full">
                <MonitorDot className="text-brand-red mx-auto mb-8" size={40} />
                <h3 className="text-white font-bold uppercase tracking-widest mb-4">Config & Integration</h3>
                <p className="text-brand-accent/50 text-sm leading-relaxed">
                  Our team configures, integrates, and monitors your e-invoicing systems for seamless operation.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.2} className="h-full">
              <div className="bg-brand-black border border-white/5 p-12 hover:border-brand-red/30 transition-all group h-full">
                ...
                <h3 className="text-white font-bold uppercase tracking-widest mb-4">Technical Specs</h3>
                <p className="text-brand-accent/50 text-sm leading-relaxed">
                  Making sure every invoice meets the technical and regulatory specifications of the relevant jurisdiction.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.3} className="h-full">
              <div className="bg-brand-black border border-white/5 p-12 hover:border-brand-red/30 transition-all group h-full">
                <Zap className="text-brand-red mx-auto mb-8" size={40} />
                <h3 className="text-white font-bold uppercase tracking-widest mb-4">Ongoing Monitoring</h3>
                <p className="text-brand-accent/50 text-sm leading-relaxed">
                  Continuous exception handling and compliance reporting to keep your digital flow uninterrupted.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                "E-invoicing system selection and integration",
                "Configuration aligned to regulatory requirements",
        ...
        <div className="container-custom relative z-10 text-center">
          <ScrollReveal>
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white uppercase max-w-4xl mx-auto leading-tight mb-8">
              Because compliance keeps moving forward. So do we.
            </h2>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="container-custom text-center">
          <ScrollReveal>
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase mb-12 tracking-tighter">
              Digital Compliance. <br />Simplified.
            </h2>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link href="/contact" className="btn-primary !px-12 !py-5">
                <span className="flex items-center gap-3">
                  Talk to Our E-Invoicing Team <ArrowRight size={18} />
                </span>
              </Link>
